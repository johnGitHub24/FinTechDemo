package com.fintech.demo.order.auth;
...
/**
 * 【職責】Auth 整合測試：登入成功／錯誤密碼／缺欄位。
 * 【技巧】MockMvc + DemoTestFixtures JSON。
 * 【概念】Case ID 與 docs/test-data/auth 對齊。
 */
class AuthIntegrationTest extends OrderIntegrationTestBase {
