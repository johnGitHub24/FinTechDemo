package com.fintech.demo.risk.config;
...
class StartupInfoLoggerTest {
    ...
    void enabled_printsBannerWithoutProbe() {
        ...
        when(env.getProperty("startup.info.project-name", "FinTechDemo Risk")).thenReturn("FinTechDemo Risk");
        ...
        when(env.getProperty("spring.datasource.url", "jdbc:h2:mem:risk")).thenReturn("jdbc:h2:mem:risk");
        ...
        assertThat(out).contains("FinTechDemo Risk 後端已啟動");
