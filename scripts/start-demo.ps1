...
if ($Minimal) {
    ...
    Write-Host ""
    Write-Host "Or one-shot: .\scripts\start-demo.ps1 -StartMinimal"
...
Write-Host "0. .\scripts\start-demo.ps1 -UpInfra   # Kafka+Redis"
Write-Host "1. .\gradlew.bat :risk-service:bootRun"
...
Write-Host "  .\scripts\start-demo.ps1 -StartMinimal [-OpenDocs]"
